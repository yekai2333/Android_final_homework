...
public class WeatherFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TabLayout t1 = view.findViewById(R.id.tab_weather);
        ViewPager vp = view.findViewById(R.id.vp_weather);
    ...
    public static class FragmentPagersAdapter extends FragmentPagerAdapter {

        private final String[] listTitle = {"今日","推荐"};
